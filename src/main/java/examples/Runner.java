...
public class Runner {
  ...
  private static final String WEB_EXAMPLES_DIR = "examples-todos";
  ...
  public static void runExample(String exampleDir, String verticleID, VertxOptions options, DeploymentOptions deploymentOptions) {
    ...
    LOGGER.info("Service Start 1 = options ===>" + options);
    // Smart cwd detection
    ...
    LOGGER.info("Service Start 2 = exampleDir ===>" + exampleDir);
    LOGGER.info("Service Start 3 = verticleID ===>" + verticleID);

    System.setProperty("vertx.cwd", exampleDir);
    Consumer<Vertx> runner = vertx -> {
      try {
        if (deploymentOptions != null) {
            LOGGER.info("Service Start 4 = deploymentOptions ===>" + deploymentOptions);
